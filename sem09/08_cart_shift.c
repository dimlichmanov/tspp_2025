...
int main(int argc, char* argv[]) {
    ...
    /* Пусть MPI за нас определит размер топологии по числу мировых процессов */
    ...
    /* Хотим определить всех наших соседей */
    enum DIRECTIONS {DOWN, UP, LEFT, RIGHT};
    char* neighbours_names[4] = {"down", "up", "left", "right"};  
    int neighbours_ranks[4];

    /* Двигаем топологию виртуально, сначала по строкам, потом по столбцам */
    /* Обычно направление UP - это когда ранги процессов возрастают (некоторые реализации MPI могут сделать по-другому, смотрите как у вас)*/
