...
int main(int argc, char* argv[]) {
    ...
    if (my_rank == 2) {
        ...
        for (int i = 0; i < 100; i++ ) {
            ...
            /* Тут можем делать что угодно, пока посылка происходит где-то на фоне*/

            /* Тут мы понимаем, что нам больше нечего делать, будем дожидаться сообщения 
            (а если оно уже дошло, возврат из этой функции будет мгновенным)*/
